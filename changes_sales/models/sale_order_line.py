...
class SaleOrderLine(models.Model):
        ...
        akias = fields.Integer(related='product_id.akias' ,string="Akias")
        ...
        discount = fields.Float(string='Discount', default=0.000)
        ...
        def _compute_amount(self):
                for line in self:
                        ...
                        line.update({
                                'price_subtotal': (line.price_unit * line.product_uom_qty) - ( line.discount_amount * line.product_uom_qty),
                ...
                for line in self:
                        if line.discount_amount != 0:
                                ...
                                discount = ((self.product_uom_qty * self.price_unit) - (
                                        (self.product_uom_qty * self.price_unit) - self.discount_amount)) / (
